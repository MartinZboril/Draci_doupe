...
{
    class EgyptsShopBehavior : IMarketBehavior
    {
        public EgyptsShopBehavior()
        {

        }
        public EgyptsShopBehavior(int Id, string Name, string Type, int Price)
        {
            _itemid = Id;
            _itemname = Name;
            _itemtype = Type;
        ...
        public void MarketItems(List<int> Id, List<string> Name, List<string> Type, List<int> Price)
        {
            ...
            {
                if (Type[i].Equals("Předměty Egypta"))
                {
                    Item_ID.Add(Id[i]);
